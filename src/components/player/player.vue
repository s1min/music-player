  ...
  <div class="player" v-show="playlist.length > 0"> 
    <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          ...
          <h2 class="subtitle"><span class="space">—</span>{{currentSong.singer}}<span class="space">—</span></h2>
        </div>
        <div class="middle" @touchstart.prevent.stop="middleTouchStart" @touchmove.prevent.stop="middleTouchMove" @touchend="middleTouchEnd">
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img width="40" height="40" :class="cdCls" :src="currentSong.image" alt="">
        </div>
        <div class="text">
        ...
        <div class="control">
          <v-progress-circle :percent="percent" :radius="radius">
